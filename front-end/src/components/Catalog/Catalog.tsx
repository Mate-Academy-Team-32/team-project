...
import { type View, type Sort, type Label } from '@/app/types/types';
    ...
    <>
      ...
      <section className="Catalog__pre">
        ...
        <div className="Catalog__buttons">
          <div className={cn('dropdown', isClickedSort && 'is-active')}>
            <div className="dropdown-trigger">
              <button
                ...
                onClick={() => {
                  setIsClickedSort((currentState) => !currentState);
                }}
                aria-haspopup="true"
          ...
          <button
            type="button"
            onClick={toggleView}
            className={cn('Catalog__view', `Catalog__view--${view}`)}
          >
            {view} View
          </button>
        </div>
      ...
      <section className="Catalog">
        <form action="/catalog" method="get" className="Catalog__filters">
          ...
          <section className="handling-menu handling-menu--filters">
            ...
            <button type="submit" className="button button--show">
              Show (12)
            </button>
          </section>
        </form>
