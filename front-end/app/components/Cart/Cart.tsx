...
export function Cart() {
  return (
    <section className="Cart">
      ...
      <form action="/" method="post" className="Cart__container form">
        ...
        <section className="Cart__orders order">
          ...
          <div className="order__details">
            <p className="order__name" style={{ textTransform: 'uppercase' }}>
              Product
            </p>
            <p className="order__price" style={{ textTransform: 'uppercase' }}>
              Total
            </p>
          </div>
          ...
          <div className="order__choice">
            <input type="radio" className="form__radio" name="post" />
            <input type="radio" className="form__radio" name="post" />
          </div>
          ...
          <div className="order__payment">
            <div className="order__payment--cash">
              ...
              <p>
                You can order cash on delivery without any prepayments. However,
                consider the postage fee for COD services.
              </p>
            </div>
            ...
            <div className="order__payment--card">
              ...
              <p>
                Pay securely by credit/debit card or Apple/Google Pay with
                Fondy.
              </p>
            </div>
          </div>
